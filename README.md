...
## Description
Данный дипломный проект представляет собой пример автоматизации тестирования веб-приложения с использованием языка программирования Java. Основная цель проекта — продемонстрировать знания и навыки в области тестирования программного обеспечения, включая создание тестовых сценариев, применение различных подходов к тестированию, а также использование популярных инструментов и библиотек.
